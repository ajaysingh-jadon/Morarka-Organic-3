...
if (document.querySelector(".slider-box-event")) {
...
if (document.querySelector(".slider-s-project")) {
    var projectSlider = new Swiper(".slider-s-project", {
        slidesPerView: 1,
        spaceBetween: 30,
        loop: true,
        speed: 1000,
